...
toc: true
---
# 1. 개요(Executive Summary)(마스크 세부사항 명세)  - 여상원

```
https://kbhmask.co.kr/%ec%9d%98%ec%95%bd%ec%99%b8%ed%92%88-%eb%a7%88%ec%8a%a4%ed%81%ac/
```
위 링크에 있는 3D 마스크 기능 명세, 정리
조사했던 벤치마크 기준 내용

# 타깃 층 명세
* 의료인 타깃 층 명세 -> 구체적으로.
* KF94 마스크 사용 -> 선별 진료소 등?
...
* -> 더 자세히 정리
* 이러이러한 벤치마크 항목의 개선을 하겠다.

# 3. 마스크 구조 분해 (Part Breakdown) - 구예훈, 서유상
...
# 5. 재료별 심층 프로파일 -> PP, PVDF, Al, 폴리우레탄 등 재료 명세
...
* 이유: 실누설이 총 침투의 지배적 요인—필터 효율

# 8 결론
* 어떤 벤치마크가 얼마나 개선되는가? 예상치 작성
